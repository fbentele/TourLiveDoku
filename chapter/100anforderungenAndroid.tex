\section{Anforderungen Android und Device Management Portal}
...
\begin{longtable}{p{4.4cm} p{3cm} p{4.4cm}}
...
Log um Fehlerquellen zu eruieren. \newline
	...
	\begin{itemize}
		...
		\item Hintergrundbeleuchtung (Ein / Ausschalten > Stromsparfunktion)
...
\subsection{Anforderungen – Neues Aufnahmesystem [Android App]}
...
Es folgt eine Grobübersicht darüber, wie das neue System funktionieren soll.
\begin{figure}[H]
	\centering
	\includegraphics[width=150mm]{images/android/BigPicture_AndroidClient.png}
	\caption{Grobübersicht Zusammenspiel Aufnahmesystem – Server – Mobilfunknetz}
\end{figure}
