...
\paragraph{ORMLite\footnote{ORMLite, \url{ormlite.com}, aufgerufen am 02.05.2013}} ORMLite ist eine OpenSource Java Library, welche das Object-Relational Mapping (ORM) übernimmt. ORMLite bietet eine speziell auf Android angepasste Distribution. Um Objektattribute zur Persistierung zu markieren, werden Java Annotationen verwendet. Aufgrund dieser Annotationen erstellt ORMLite die SQLite Datenbank. Darüber hinaus werden mit ORMLite alle Zugriffe auf die SQLite Datenbank ausgeführt. In dieser Arbeit wird die ORMLite Version 4.45 verwendet. Diese Library wird verwendet um die gesammelten Informationen lokal in einer Datenbank speichern zu können und um die Datenkonsistenz bei Verbindungsunterbrüchen sicherstellen zu können.
