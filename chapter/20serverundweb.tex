...
Sämtliche Informationen zu der Aufgezeichneten Position wird in der Form eines ValueContainers übertragen. Der ValueContainer ist im Folgenden beispielhaft als JSON Objekt dargestellt.
\begin{figure}[H]
	\centering
