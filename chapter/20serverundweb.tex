...
Die folgenden Technologien wurden verwendet für die Umsetzung des TourLive Server.
...
Im Packagediagramm \ref{fig:tourlivewebpackage} sind die Schichten zu erkennen. So wurde das Domainmodel im Package \textit{Model} abgebildet, die Datenzugriffsobjekte im \textit{DAO} Package und die Zugriffscontroller im Package \textit{Controller}.
