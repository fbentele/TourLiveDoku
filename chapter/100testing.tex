...
Zu jeder negativen Erkenntnis wird zudem eine Massnahme vorgeschlagen. Massnahmen die nicht mehr im Rahmen dieser Arbeit umgesetzt werden können werden mit einem  \textsuperscript{*} markiert.
